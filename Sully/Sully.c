...
dprintf(fd, s, 10, 10, 10, 10, 10, 34, 37, 34, 10, 34, 37, 37, 34, 10, 34, s, 34, 10, 10, (i == -1) ? 0 : i, 10, 10, 34, 37, 34); asprintf(&compile, COMPILE, i, i); asprintf(&exec, "./Sully_%d", i); system(compile); system(exec); }